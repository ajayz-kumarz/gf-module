...
- **Drift Management**: Automatically strips volatile fields (`id`, `version`) from dashboard JSON files to minimize drift while preserving `uid` for identity and `time` to prevent perpetual drift against Grafana defaults.
